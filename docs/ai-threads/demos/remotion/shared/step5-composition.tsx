...
// Bare Composition — no <Player>. Used by the docs Player wrapper AND by the
// CLI render entry at remotion/Root.tsx. Single source of truth.
export const Step5Composition = () => {
  return (
